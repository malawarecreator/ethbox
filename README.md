...
running command...
$ ethbox (--version)
ethbox-cli/0.0.6 win32-x64 node-v22.13.1
$ ethbox --help [COMMAND]
USAGE
  $ ethbox COMMAND
...
...
_See code: [src/commands/auth/login.ts](https://github.com/malawarecreator/ethbox/blob/v0.0.6/src/commands/auth/login.ts)_
...
_See code: [src/commands/tx/send.ts](https://github.com/malawarecreator/ethbox/blob/v0.0.6/src/commands/tx/send.ts)_
...
_See code: [src/commands/wallet/create.ts](https://github.com/malawarecreator/ethbox/blob/v0.0.6/src/commands/wallet/create.ts)_
...
_See code: [src/commands/wallet/inspect.ts](https://github.com/malawarecreator/ethbox/blob/v0.0.6/src/commands/wallet/inspect.ts)_
<!-- commandsstop -->
* [`ethbox auth login PRIVATEKEY`](#ethbox-auth-login-privatekey)
* [`ethbox help [COMMAND]`](#ethbox-help-command)
* [`ethbox plugins`](#ethbox-plugins)
